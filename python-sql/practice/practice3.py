...
#     }}
# ]
# objects=Garage[0]["Cars"]["sports_cars"]
# for i in objects:
#     if "Lamborghini" in i["Company"]:
#         print(i)
...
Garage = [
    ...
    {"Bikes" : {
        "Bikes" : [
            ...
            {"Company" : "BMW", "Models" : [
                {1 : {"Name" : "BMW M 1000 RR", "Price" : {1 : "₹42,00,000", 2 : "₹44,00,000", 3 : "₹45,00,000"}}},
                {2 : {"Name" : "BMW S 1000 R", "Price" : {1 : "₹19,00,000", 2 : "₹20,00,000", 3 : "₹20,50,000"}}},
                {3 : {"Name" : "BMW R 1200 R", "Price" : {1 : "₹15,00,000", 2 : "₹15,50,000", 3 : "₹16,00,000"}}}
            ]},
            {"Company" : "Ducati", "Models" : [
...
for bike in Garage:
    if "Bikes" in bike:
        for j in bike["Bikes"]["Bikes"]:
            if j["Company"] == "Kawasaki":
                d_company=j
                d_model=d_company["Models"]
                model_info = {}
                for i in d_model:
                    for j,k in i.items():
                        value=k["Price"]
